...
WORKDIR /data/server
RUN git clone https://github.com/wwtg99/image_filter_server.git server && \
...
RUN pip3 install -i https://pypi.douban.com/simple numpy pillow

# Install image_filter tool
WORKDIR /data/server
RUN git clone https://github.com/wwtg99/image_filter.git
